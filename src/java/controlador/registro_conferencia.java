...
public class registro_conferencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombreConferencia = request.getParameter("nombre_conferencia");
        ...
        conferencia.setId(0);
        conferencia.setNombreConferencia(nombreConferencia);
        conferencia.setNombreExpositor(nombreExpositor);
